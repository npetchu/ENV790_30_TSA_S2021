...
getwd()
setwd("/Users/narissapetchumrus/Desktop/Duke Folder/ENV TSA/ENV790_30_TSA_S2021/Data")

Table_new <- read.table(file="/Users/narissapetchumrus/Desktop/Duke Folder/ENV TSA/ENV790_30_TSA_S2021/Data/Table_10.1_Renewable_Energy_Production_and_Consumption_by_source.xlsx", skip=9)
...
```{r}
Table_new <- read_excel(file="/Users/narissapetchumrus/Desktop/Duke Folder/ENV TSA/ENV790_30_TSA_S2021/Data/Table_10.1_Renewable_Energy_Production_and_Consumption_by_Source.xlsx" ,skip = 9)
Energy <- Table-new[,c(1,4,5,6)]
